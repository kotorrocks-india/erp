...
- ui/: UI components
  - assignment_list.py: List view
  - assignment_editor.py: Create/Edit form
  - assignment_marks.py: Marks entry & scaling
- schemas/: Database schemas
  - assignments_schema.py: All assignment tables
"""
...
# Add project root to path for accessing connection and context
...
def render_assignment_editor(service, offering_id, offering):
    ...
    try:
        from screens.assignments.ui.assignment_editor import render_editor
...
def render_marks_entry(service, offering_id, offering):
    ...
    try:
        from screens.assignments.ui.assignment_marks import render_marks
