...
def _render_page_access_management(engine, admin_email):
    ...
    st.caption("Control which user roles can view or edit each page across the entire application.")
    ...
    try:
        ...
        st.info("💡 Check/uncheck boxes to grant or revoke permissions. Changes are saved instantly.")
...
def render():
    ...
    main_tab1, main_tab2 = st.tabs([
        ...
        "🔒 Page Role Access Management"
    ])

    # --- TAB 1: Approval Workflow Management ---
    with main_tab1:
        st.markdown("Configure users who can approve specific actions, view statistics, and perform bulk assignments.")
        ...
        # Create sub-tabs for approval management
    ...
    # --- TAB 2: Page Role Access Management ---
    with main_tab2:
